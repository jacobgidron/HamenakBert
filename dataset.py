...
class textDataset(Dataset):
    def __init__(self, base_paths, maxlen, minlen, tokenizer, do_split_by_length = None):
        ...
        self.maxlen = maxlen
        self.minlen = minlen
        self.do_split_by_length = do_split_by_length
        ...
        for (_, heb_items) in corpora:
            if self.do_split_by_length:
